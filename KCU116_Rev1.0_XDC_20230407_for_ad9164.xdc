...
set_property IOSTANDARD LVCMOS18 [get_ports {DDS1_TXEN_0[0]}]
set_property PACKAGE_PIN AC17 [get_ports DDS1_MOSI]
set_property IOSTANDARD LVCMOS18 [get_ports DDS1_MOSI]
set_property IOSTANDARD LVCMOS18 [get_ports DDS1_SCK]

set_property PACKAGE_PIN AA20 [get_ports DDS1_MISO]
set_property IOSTANDARD LVCMOS18 [get_ports DDS1_MISO]

set_property PACKAGE_PIN AB20 [get_ports {DDS1_CS[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DDS1_CS[0]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports {DDS2_TXEN_0[0]}]
set_property PACKAGE_PIN AF17 [get_ports DDS2_MOSI]
set_property IOSTANDARD LVCMOS18 [get_ports DDS2_MOSI]
set_property IOSTANDARD LVCMOS18 [get_ports DDS2_SCK]


set_property PACKAGE_PIN AA18 [get_ports {DDS2_CS[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DDS2_CS[0]}]
set_property PACKAGE_PIN AC19 [get_ports {DDS2_CS[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DDS2_CS[1]}]
set_property PACKAGE_PIN AD19 [get_ports {DDS2_CS[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DDS2_CS[2]}]
set_property PACKAGE_PIN AD25 [get_ports {DDS2_CS[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DDS2_CS[3]}]
