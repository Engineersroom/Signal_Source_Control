...
volatile u8 FTH1_REGSTER3[3] = {0x08, 0x08, 0xAA};
volatile u8 FTH1_REGSTER4[3] = {0x08, 0x09, 0x2A};
volatile u8 SAND_complete1[3] = {0x01, 0x13, 0x00};
volatile u8 SAND_complete2[3] = {0x01, 0x13, 0x01};
volatile u8 Global_AD9164_recv[3];
volatile u8 FTH1_TEST_REGSTER1[24] = {
    0x08, 0x06, 0x44, //
    0x00, 0x00, 0x00, //
    0x08, 0x07, 0x44, //
    0x00, 0x00, 0x00, //
...
char Init_ADF4355[60] = {
    ...
    0x00, 0x00, 0x04, 0x1C, //
    0x00, 0x61, 0x30, 0x0B, //
    0x00, 0xc0, 0x0C, 0xBA, // 0x00, 0xc0 ,0x0C,0xBA
    0x08, 0x08, 0x7F, 0xF9, // 0x08,0x08,0x7F,0xF9
    0x10, 0x2D, 0x04, 0x28, //
    0x12, 0x00, 0x00, 0x07, //
    0x35, 0x00, 0x66, 0x76, //
    0x00, 0x80, 0x00, 0x25, //
    0x34, 0x00, 0x89, 0x84, // 0x34,0x00,0x89,0x84
    0x00, 0x00, 0x00, 0x03, //
    0x00, 0x00, 0x7D, 0x02, // 0x00, 0x00, 0x7D, 0x02
    0x00, 0x00, 0x00, 0x01, //
    0x00, 0x20, 0x12, 0xC0  // 0x00, 0x20, 0x12,0xC0

};
// Non Ref Clock used code

char Init_ADF4355_sub[60] = {
    0x00, 0x00, 0x00, 0x14, //
    0x32, 0x00, 0x8B, 0x84, //
    0x00, 0x00, 0x04, 0x1C, //
    0x00, 0x61, 0x30, 0x0B, //
...
char Freq_VNA_Arr[800] = {
    ...
    0x00, 0x00, 0x00, 0x79, // 136.125GHz
    0xC7, 0x71, 0x1C, 0x79, // 136.25GHz
    0x8E, 0xE3, 0x38, 0x79, // 136.375GHz
    0x55, 0x55, 0x55, 0x79, // 136.5GHz
    0x1C, 0xC7, 0x71, 0x79, // 136.625GHz
    0xE3, 0x38, 0x8E, 0x79, // 136.75GHz
    0xAA, 0xAA, 0xAA, 0x79, // 136.875GHz
    0x71, 0x1C, 0xC7, 0x79, // 137GHz
    0x38, 0x8E, 0xE3, 0x79, // 137.125GHz
    0x00, 0x00, 0x00, 0x7A, // 137.25GHz
    0xC7, 0x71, 0x1C, 0x7A, // 137.375GHz
    0x8E, 0xE3, 0x38, 0x7A, // 137.5GHz
    0x55, 0x55, 0x55, 0x7A, // 137.625GHz
    0x1C, 0xC7, 0x71, 0x7A, // 137.75GHz
    0xE3, 0x38, 0x8E, 0x7A, // 137.875GHz
    0xAA, 0xAA, 0xAA, 0x7A, // 138GHz
    0x71, 0x1C, 0xC7, 0x7A, // 138.125GHz
    0x38, 0x8E, 0xE3, 0x7A, // 138.25GHz
    0x00, 0x00, 0x00, 0x7B, // 138.375GHz
    0xC7, 0x71, 0x1C, 0x7B, // 138.5GHz
    0x8E, 0xE3, 0x38, 0x7B, // 138.625GHz
    0x55, 0x55, 0x55, 0x7B, // 138.75GHz
    0x1C, 0xC7, 0x71, 0x7B, // 138.875GHz
    0xE3, 0x38, 0x8E, 0x7B, // 139GHz
    0xAA, 0xAA, 0xAA, 0x7B, // 139.125GHz
    0x71, 0x1C, 0xC7, 0x7B, // 139.25GHz
    0x38, 0x8E, 0xE3, 0x7B, // 139.375GHz
    0x00, 0x00, 0x00, 0x7C, // 139.5GHz
    0xC7, 0x71, 0x1C, 0x7C, // 139.625GHz
    0x8E, 0xE3, 0x38, 0x7C, // 139.75GHz
    0x55, 0x55, 0x55, 0x7C, // 139.875GHz
    0x1C, 0xC7, 0x71, 0x7C, // 140GHz
    0xE3, 0x38, 0x8E, 0x7C, // 140.125GHz
    0xAA, 0xAA, 0xAA, 0x7C, // 140.25GHz
    0x71, 0x1C, 0xC7, 0x7C, // 140.375GHz
    0x38, 0x8E, 0xE3, 0x7C, // 140.5GHz
    0x00, 0x00, 0x00, 0x7D, // 140.625GHz
    0xC7, 0x71, 0x1C, 0x7D, // 140.75GHz
    0x8E, 0xE3, 0x38, 0x7D, // 140.875GHz
    0x55, 0x55, 0x55, 0x7D, // 141GHz
    0x1C, 0xC7, 0x71, 0x7D, // 141.125GHz
    0xE3, 0x38, 0x8E, 0x7D, // 141.25GHz
    0xAA, 0xAA, 0xAA, 0x7D, // 141.375GHz
    0x71, 0x1C, 0xC7, 0x7D, // 141.5GHz
    0x38, 0x8E, 0xE3, 0x7D, // 141.625GHz
    0x00, 0x00, 0x00, 0x7E, // 141.75GHz
    0xC7, 0x71, 0x1C, 0x7E, // 141.875GHz
    0x8E, 0xE3, 0x38, 0x7E, // 142GHz
    0x55, 0x55, 0x55, 0x7E, // 142.125GHz
    0x1C, 0xC7, 0x71, 0x7E, // 142.25GHz
    0xE3, 0x38, 0x8E, 0x7E, // 142.375GHz
    0xAA, 0xAA, 0xAA, 0x7E, // 142.5GHz
    0x71, 0x1C, 0xC7, 0x7E, // 142.625GHz
    0x38, 0x8E, 0xE3, 0x7E, // 142.75GHz
    0x00, 0x00, 0x00, 0x7F, // 142.875GHz
    0xC7, 0x71, 0x1C, 0x7F, // 143GHz
    0x8E, 0xE3, 0x38, 0x7F, // 143.125GHz
    0x55, 0x55, 0x55, 0x7F, // 143.25GHz
    0x1C, 0xC7, 0x71, 0x7F, // 143.375GHz
    0xE3, 0x38, 0x8E, 0x7F, // 143.5GHz
    0xAA, 0xAA, 0xAA, 0x7F, // 143.625GHz
    0x71, 0x1C, 0xC7, 0x7F, // 143.75GHz
    0x38, 0x8E, 0xE3, 0x7F, // 143.875GHz
    0x00, 0x00, 0x00, 0x80, // 144GHz
    0xC7, 0x71, 0x1C, 0x80, // 144.125GHz
    0x8E, 0xE3, 0x38, 0x80, // 144.25GHz
    0x55, 0x55, 0x55, 0x80, // 144.375GHz
    0x1C, 0xC7, 0x71, 0x80, // 144.5GHz
    0xE3, 0x38, 0x8E, 0x80, // 144.625GHz
    0xAA, 0xAA, 0xAA, 0x80, // 144.75GHz
    0x71, 0x1C, 0xC7, 0x80, // 144.875GHz
    0x38, 0x8E, 0xE3, 0x80, // 145GHz
    0x00, 0x00, 0x00, 0x81, // 145.125GHz
    0xC7, 0x71, 0x1C, 0x81, // 145.25GHz
    0x8E, 0xE3, 0x38, 0x81, // 145.375GHz
    0x55, 0x55, 0x55, 0x81, // 145.5GHz
    0x1C, 0xC7, 0x71, 0x81, // 145.625GHz
    0xE3, 0x38, 0x8E, 0x81, // 145.75GHz
    0xAA, 0xAA, 0xAA, 0x81, // 145.875GHz
    0x71, 0x1C, 0xC7, 0x81, // 146GHz
    0x38, 0x8E, 0xE3, 0x81, // 146.125GHz
    0x00, 0x00, 0x00, 0x82, // 146.25GHz
    0xC7, 0x71, 0x1C, 0x82, // 146.375GHz
    0x8E, 0xE3, 0x38, 0x82, // 146.5GHz
    0x55, 0x55, 0x55, 0x82, // 146.625GHz
    0x1C, 0xC7, 0x71, 0x82, // 146.75GHz
    0xE3, 0x38, 0x8E, 0x82, // 146.875GHz
    0xAA, 0xAA, 0xAA, 0x82, // 147GHz
    0x71, 0x1C, 0xC7, 0x82, // 147.125GHz
    0x38, 0x8E, 0xE3, 0x82, // 147.25GHz
    0x00, 0x00, 0x00, 0x83, // 147.375GHz
    0xC7, 0x71, 0x1C, 0x83, // 147.5GHz
    0x8E, 0xE3, 0x38, 0x83, // 147.625GHz
    0x55, 0x55, 0x55, 0x83, // 147.75GHz
    0x1C, 0xC7, 0x71, 0x83, // 147.875GHz
    0xE3, 0x38, 0x8E, 0x83, // 148GHz
    0xAA, 0xAA, 0xAA, 0x83, // 148.125GHz
    0x71, 0x1C, 0xC7, 0x83, // 148.25GHz
    0x38, 0x8E, 0xE3, 0x83, // 148.375GHz
