...
HD_PWD='D:/DMTS/MOLIT_Shoe_Schaner/Development/FPGA/Signal_Source_Control/Vivado/Signal_Souce_Control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Signal_Souce_Control_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Signal_Souce_Control_BD_wrapper.tcl
